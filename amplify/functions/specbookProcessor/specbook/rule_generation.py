...
def build_rules_prompt(trades: list[str]) -> str:
    ...
    prompt_template = load_prompt_template(PROMPT_RULES_PATH)
    return prompt_template.replace(PROMPT_TRADE_LIST_PLACEHOLDER, trade_list)
    ...
    for attempt in range(1, max_retries + 1):
        ...
        for idx, response in zip(remaining, responses):
            ...
            try:
                ...
                results[idx] = rules_from_payload(payload, chunk_name)
